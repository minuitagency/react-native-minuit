    ...
    >
      <DismissKeyboard>
        ...
        <PlacesInput
          ...
          placeHolder={newCoordinates?.address || "Quelle est l'adresse de l'évènement?"}
          iconInput={
            <Image
              style={{ height: 20, width: 30, tintColor: Palette.primary }}
              resizeMode="contain"
          ...
          onSelect={inputData => {
            ...
            setNewCoordinates(formatCoordinates({ latitude, longitude, address }));
            animateToCoordinates({ coordinates: { latitude, longitude }, mapRef });
          }}
          language="fr-FR"
        />
        <Button
