...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <View style={[{ height: 52, backgroundColor: Palette.lightGrey, borderRadius: 10 }, style]}>
      <TextInput
        style={[{ flex: 1, paddingHorizontal: 10 }, Fonts.primary.semibold(15, Palette.blackBleuMarine), inputStyle]}
